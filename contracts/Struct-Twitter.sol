...
contract Twitter {
    ...
    function postTweet(uint256 _id, string memory _content) public {
        Tweet memory newTweet = Tweet(_id, _content, msg.sender, block.timestamp);
    ...
    function getSingleTweet(address user, uint256 index) public view returns (Tweet memory) {
